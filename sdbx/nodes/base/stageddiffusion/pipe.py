...
def encode_prompt(prompts, tokenizers, text_encoders):
  ...
  for prompt, tokenizer, text_encoder in zip(prompts, tokenizers, text_encoders):
    ...
    prompt_embeds = text_encoder(cond_input.input_ids.to(token_device), output_hidden_states=True)
...
if gen_device!="cpu": pipe.enable_model_cpu_offload()
...
if gen_device or token_device or latent_device == "cuda":
